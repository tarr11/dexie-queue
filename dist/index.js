...
var dexie_1 = __webpack_require__(1);

var SerializedJob = function () {
    function SerializedJob() {
        _classCallCheck(this, SerializedJob);
    }

    _createClass(SerializedJob, null, [{
        key: "Parse",
        value: function Parse(sj) {
            var fn = Function(sj.fn);
            var obj = JSON.parse(sj.value);
            return {
...
var Database = function (_dexie_1$default) {
    _inherits(Database, _dexie_1$default);

    function Database() {
        _classCallCheck(this, Database);

        var _this = _possibleConstructorReturn(this, (Database.__proto__ || Object.getPrototypeOf(Database)).call(this, "dexie-queue"));
...
var Queue = function () {
    ...
    _createClass(Queue, [{
        ...
        value: function poll() {
            ...
            this.db.jobs.orderBy("id desc").each(function (job) {
                var res = SerializedJob.Parse(job);
                try {
                    res.fn(res.value);
                    _this2.db.jobs.delete(job.id);
                } catch (e) {
                    _this2.db.jobs.update(job.id, { error: e });
                }
            }).then(function () {
                return setTimeout(_this2.poll, 1000);
            });
        }
    }, {
        key: "Start",
